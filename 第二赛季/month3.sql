...
CREATE TABLE featrue_label_3_one
AS
SELECT b.user_c_num
	, c.user_b
	, f.b_dis
...
JOIN user_get_num_3 n
ON n.user_id = a.user_id;


CREATE TABLE featrue_label_3
AS
SELECT 
	o.c_time
	, p.user_time
...
CREATE TABLE featrue_label_3_more
AS
SELECT
	ee.times 
	,bb.user_c_time
