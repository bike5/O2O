...
--month 5
CREATE TABLE featrue_label_5_one
AS
SELECT b.user_c_num
	, c.user_b
	, f.b_dis
...
JOIN user_get_num_5 n
ON n.user_id = a.user_id;




CREATE TABLE featrue_label_5
AS
SELECT 
	o.c_time
	, p.user_time
...
CREATE TABLE featrue_label_5_more
AS
SELECT 
	ee.times 
	,bb.user_c_time
