...
--month 4
CREATE TABLE featrue_label_4_one
AS
SELECT b.user_c_num
	, c.user_b
	, f.b_dis
...
JOIN user_get_num_4 n
ON n.user_id = a.user_id;


CREATE TABLE featrue_label_4
AS
SELECT 
	o.c_time
	, p.user_time
...
CREATE TABLE featrue_label_4_more
AS
SELECT
	ee.times 
	,bb.user_c_time
